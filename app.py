...
def home():
    return jsonify({
        "message": "🚀 Welcome to my FlaskApp AutoDeployer – Mini Dashboard API Version"
    })
...
def get_users():
    users = [
        {"id": 1, "name": "Harshwardhan Jadhav", "role": "DevOps Engineer"},
        {"id": 2, "name": "Leonardo Yadav", "role": "Data Science Engineer"}
    ]
